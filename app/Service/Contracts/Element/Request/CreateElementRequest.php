...
/**
 * @OA\Schema(
 *     schema="CreateElementRequest",
 *     title="Create Element Request",
 *     description="Create element request schema",
 *     required={"departure_id", "role_initialize_id", "role_origin_id"}
 * )
 */
class CreateElementRequest extends AuditableRequest
{
...
/**
 * @OA\Schema(
 *     schema="AcgtCreateRequest",
 *     title="Acgt Create Request",
 *     description="Acgt create request schema",
 *     required={"departure_id", "acgt", "init", "acgtable_id", "acgtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="acgt",
 ...
 *              )
 *          ),
 *          @OA\Schema(ref="#/components/schemas/CreateElementRequest")
 *     }
 * )
 */
...
/**
 * @OA\Schema(
 *     schema="AcztCreateRequest",
 *     title="Aczt Create Request",
 *     description="Aczt create request schema",
 *     required={"departure_id", "aczt", "init", "acztable_id", "acztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="aczt",
...
/**
 * @OA\Schema(
 *     schema="AditCreateRequest",
 *     title="Adit Create Request",
 *     description="Adit create request schema",
 *     required={"departure_id", "adit", "init", "aditable_id", "aditable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="adit",
...
/**
 * @OA\Schema(
 *     schema="AegtCreateRequest",
 *     title="Aegt Create Request",
 *     description="Aegt create request schema",
 *     required={"departure_id", "aegt", "init", "aegtable_id", "aegtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="aegt",
...
/**
 * @OA\Schema(
 *     schema="AeztCreateRequest",
 *     title="Aezt Create Request",
 *     description="Aezt create request schema",
 *     required={"departure_id", "aezt", "init", "aeztable_id", "aeztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="aezt",
...
/**
 * @OA\Schema(
 *     schema="AghtCreateRequest",
 *     title="Aght Create Request",
 *     description="Aght create request schema",
 *     required={"departure_id", "aght", "init", "aghtable_id", "aghtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="aght",
...
/**
 * @OA\Schema(
 *     schema="AobtCreateRequest",
 *     title="Aobt Create Request",
 *     description="Aobt create request schema",
 *     required={"departure_id", "aobt", "init", "aobtable_id", "aobtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="aobt",
...
/**
 * @OA\Schema(
 *     schema="ArdtCreateRequest",
 *     title="Ardt Create Request",
 *     description="Ardt create request schema",
 *     required={"departure_id", "ardt", "init", "ardtable_id", "ardtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="ardt",
...
/**
 * @OA\Schema(
 *     schema="ArztCreateRequest",
 *     title="Arzt Create Request",
 *     description="Arzt create request schema",
 *     required={"departure_id", "arzt", "init", "arztable_id", "arztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="arzt",
...
/**
 * @OA\Schema(
 *     schema="AsbtCreateRequest",
 *     title="Asbt Create Request",
 *     description="Asbt create request schema",
 *     required={"departure_id", "asbt", "init", "asbtable_id", "asbtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="asbt",
...
/**
 * @OA\Schema(
 *     schema="AsrtCreateRequest",
 *     title="Asrt Create Request",
 *     description="Asrt create request schema",
 *     required={"departure_id", "asrt", "init", "asrtable_id", "asrtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="asrt",
...
/**
 * @OA\Schema(
 *     schema="AtetCreateRequest",
 *     title="Atet Create Request",
 *     description="Atet create request schema",
 *     required={"departure_id", "atet", "init", "atetable_id", "atetable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="atet",
...
/**
 * @OA\Schema(
 *     schema="AtotCreateRequest",
 *     title="Atot Create Request",
 *     description="Atot create request schema",
 *     required={"departure_id", "atot", "init", "atotable_id", "atotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="atot",
...
/**
 * @OA\Schema(
 *     schema="AtstCreateRequest",
 *     title="Atst Create Request",
 *     description="Atst create request schema",
 *     required={"departure_id", "atst", "init", "atstable_id", "atstable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="atst",
...
/**
 * @OA\Schema(
 *     schema="AtttCreateRequest",
 *     title="Attt Create Request",
 *     description="Attt create request schema",
 *     required={"departure_id", "attt", "init", "atttable_id", "atttable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="attt",
...
/**
 * @OA\Schema(
 *     schema="AxotCreateRequest",
 *     title="Axot Create Request",
 *     description="Axot create request schema",
 *     required={"departure_id", "axot", "init", "axotable_id", "axotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="axot",
...
/**
 * @OA\Schema(
 *     schema="AzatCreateRequest",
 *     title="Azat Create Request",
 *     description="Azat create request schema",
 *     required={"departure_id", "azat", "init", "azatable_id", "azatable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="azat",
...
/**
 * @OA\Schema(
 *     schema="CtotCreateRequest",
 *     title="Ctot Create Request",
 *     description="Ctot create request schema",
 *     required={"departure_id", "ctot", "init", "ctotable_id", "ctotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="ctot",
...
/**
 * @OA\Schema(
 *     schema="EcztCreateRequest",
 *     title="Eczt Create Request",
 *     description="Eczt create request schema",
 *     required={"departure_id", "eczt", "init", "ecztable_id", "ecztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="eczt",
...
/**
 * @OA\Schema(
 *     schema="EditCreateRequest",
 *     title="Edit Create Request",
 *     description="Edit create request schema",
 *     required={"departure_id", "edit", "init", "editable_id", "editable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="edit",
...
/**
 * @OA\Schema(
 *     schema="EeztCreateRequest",
 *     title="Eezt Create Request",
 *     description="Eezt create request schema",
 *     required={"departure_id", "eezt", "init", "eeztable_id", "eeztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="eezt",
...
/**
 * @OA\Schema(
 *     schema="EobtCreateRequest",
 *     title="Eobt Create Request",
 *     description="Eobt create request schema",
 *     required={"departure_id", "eobt", "init", "eobtable_id", "eobtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="eobt",
...
/**
 * @OA\Schema(
 *     schema="ErztCreateRequest",
 *     title="Erzt Create Request",
 *     description="Erzt create request schema",
 *     required={"departure_id", "erzt", "init", "erztable_id", "erztable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="erzt",
...
/**
 * @OA\Schema(
 *     schema="EtotCreateRequest",
 *     title="Etot Create Request",
 *     description="Etot create request schema",
 *     required={"departure_id", "etot", "init", "etotable_id", "etotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="etot",
...
/**
 * @OA\Schema(
 *     schema="ExotCreateRequest",
 *     title="Exot Create Request",
 *     description="Exot create request schema",
 *     required={"departure_id", "exot", "init", "exotable_id", "exotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="exot",
...
/**
 * @OA\Schema(
 *     schema="SobtCreateRequest",
 *     title="Sobt Create Request",
 *     description="Sobt create request schema",
 *     required={"departure_id", "sobt", "init", "sobtable_id", "sobtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="sobt",
...
/**
 * @OA\Schema(
 *     schema="StetCreateRequest",
 *     title="Stet Create Request",
 *     description="Stet create request schema",
 *     required={"departure_id", "stet", "init", "stetable_id", "stetable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="stet",
...
/**
 * @OA\Schema(
 *     schema="StstCreateRequest",
 *     title="Stst Create Request",
 *     description="Stst create request schema",
 *     required={"departure_id", "stst", "init", "ststable_id", "ststable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="stst",
...
/**
 * @OA\Schema(
 *     schema="TobtCreateRequest",
 *     title="Tobt Create Request",
 *     description="Tobt create request schema",
 *     required={"departure_id", "tobt", "init", "tobtable_id", "tobtable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="tobt",
...
/**
 * @OA\Schema(
 *     schema="TsatCreateRequest",
 *     title="Tsat Create Request",
 *     description="Tsat create request schema",
 *     required={"departure_id", "tsat", "init", "tsatable_id", "tsatable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="tsat",
...
/**
 * @OA\Schema(
 *     schema="TtotCreateRequest",
 *     title="Ttot Create Request",
 *     description="Ttot create request schema",
 *     required={"departure_id", "ttot", "init", "ttotable_id", "ttotable_type"},
 *     allOf={
 *          @OA\Schema(
 *              @OA\Property(
 *                  property="ttot",
