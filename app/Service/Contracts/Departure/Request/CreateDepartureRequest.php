...
/**
 * @OA\Schema(
 *     schema="CreateDepartureRequest",
 *     title="Create Departure Request",
 *     description="Create departure request schema",
 *     required={"aodb_id", "airport_id", "departure_meta"}
 * )
 */
class CreateDepartureRequest extends AuditableRequest
{
    /**
     * @OA\Property(
     *     property="aodb_id",
