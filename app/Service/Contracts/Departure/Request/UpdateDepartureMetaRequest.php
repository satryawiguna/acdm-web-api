...
/**
 * @OA\Schema(
 *     schema="UpdateDepartureMetaRequest",
 *     title="Update Departure Meta Request",
 *     description="Update departure meta request schema",
 *     required={"id", "flight", "sobt", "eobt", "tobt", "aegt", "ardt", "aobt", "tsat", "ttot", "atot"}
 * )
 */
class UpdateDepartureMetaRequest extends IdentityAuditableRequest
{
    /**
     * @OA\Property(
     *     property="id",
